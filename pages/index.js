    ...
    <div className="h-screen bg-gray-100 overflow-x-hidden">
      ...
      <main className="flex h-screen flex-col  ">
        <div className="flex">
          ...
          <Sidebar />
          {/* Feed */}
          <div className="m-20 mt-5 mr-1 no-wrap grid md:grid-cols-3 gap-10">
        ...
        {/* <Feed /> */}
        <div className="ml-[375px]  mt-[-40px] mr-[150px] rounded-md p-4 flex flex-col bg-gray-50 drop-shadow-md">
