          ...
          <div className='flex flex-col gap-8 p-8'>
            ...
            <div className='flex flex-col w-[93rem] gap-2 flex-grow  rounded-lg shadow-xl  bg-[#F8F5F5]'>
              <div className='flex justify-between mt-4 ml-4 mr-4'>
                <h1 className='text-[2rem] font-semibold'>Workshop or skill</h1>
...
{Data && Data.length!==0?(
          Data.map((data)=>{
            return (<div className=' rounded-md h-[250px] overflow-hidden  justify-center bg-white w-[260px] shadow-md cursor-pointer hover:bg-[#EDEDED] hover:shadow-xl transition-all ease-linear'>
            <div className=''>
